...
[![GoDev](https://img.shields.io/static/v1?label=godev&message=reference&color=00add8)](https://pkg.go.dev/mod/github.com/NeoclubTechnology/protobuf)
[![Build Status](https://travis-ci.org/golang/protobuf.svg?branch=master)](https://travis-ci.org/golang/protobuf)

This module
([`github.com/NeoclubTechnology/protobuf`](https://pkg.go.dev/mod/github.com/NeoclubTechnology/protobuf))
...
Versions v1.4 and later of `github.com/NeoclubTechnology/protobuf` are implemented
...
See
[release note documentation](https://github.com/NeoclubTechnology/protobuf/releases)
...
*   [`proto`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/proto): Package
    ...
    serialization.
*   [`jsonpb`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/jsonpb): Package
    `jsonpb` serializes protobuf messages as JSON.
*   [`ptypes`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes): Package
    `ptypes` provides helper functionality for protobuf well-known types.
*   [`ptypes/any`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/any):
    Package `any` is the generated package for `google/protobuf/any.proto`.
*   [`ptypes/empty`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/empty):
    Package `empty` is the generated package for `google/protobuf/empty.proto`.
*   [`ptypes/timestamp`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/timestamp):
    Package `timestamp` is the generated package for
    `google/protobuf/timestamp.proto`.
*   [`ptypes/duration`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/duration):
    Package `duration` is the generated package for
    `google/protobuf/duration.proto`.
*   [`ptypes/wrappers`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/wrappers):
    Package `wrappers` is the generated package for
    `google/protobuf/wrappers.proto`.
*   [`ptypes/struct`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/ptypes/struct):
    Package `structpb` is the generated package for
    `google/protobuf/struct.proto`.
*   [`protoc-gen-go/descriptor`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/protoc-gen-go/descriptor):
    Package `descriptor` is the generated package for
    `google/protobuf/descriptor.proto`.
*   [`protoc-gen-go/plugin`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/protoc-gen-go/plugin):
    Package `plugin` is the generated package for
    `google/protobuf/compiler/plugin.proto`.
*   [`protoc-gen-go`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/protoc-gen-go):
...
[is located here](https://github.com/NeoclubTechnology/protobuf/issues).
...
[contribution guide](https://github.com/NeoclubTechnology/protobuf/blob/master/CONTRIBUTING.md)
...
*   **Internal changes**: We reserve the right to add, modify, and remove
    ...
    [`generator`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/protoc-gen-go/generator)
    package, and all packages under
    [`internal`](https://pkg.go.dev/github.com/NeoclubTechnology/protobuf/internal).
